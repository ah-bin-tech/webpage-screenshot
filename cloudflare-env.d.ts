/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 2796a8f6a3e60ea45aba3dab0adf9978)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* webpage-screenshot */;
}
